...
>
  <div class="_mw1280">
    ...
    <div class="commidityItems_dif_aic_jcc_gap64_mab32" >
      ...
      <div class="item _wi30" data-aos="fade-up" data-aos-duration="600" data-aos-delay="300">
        <div class="img_mab8">
          <img class="_fluid" src="{{ URL::asset(env('MIX_IMGPREFIX')).'/home_commodity2.png?'.rand() }}">
        </div>
        <div class="_commidityItem">
          <h4 class="title">
            <div class="_ellipsis1">002</div>
          </h4>
          <div class="_dif_aic_jcs">
            <div class="price">NT$ 890</div>
            <a href="https://oaostyle.cashier.ecpay.com.tw/product/000000000589500" target="_block" class="buy _btn_coGray900_bcGray900">立即購買</a>
          </div>
        </div>
      </div>
    ...
    <div class="bottom center">
      ...
      <p class="text">綿密而細緻，簡單卻不馬虎，沒有花俏的顏色或是口味，選擇最優良的食材並忠實呈現他們<br>
        本身的美好風味。
      </p>
      <p class="text">綿密而細緻，簡單卻不馬虎，沒有花俏的顏色或是口味，選擇最優良的食材並忠實呈現他們<br>
        本身的美好風味。
